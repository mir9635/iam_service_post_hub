...
public class PostController {
    ...
    @PostMapping("/create")
    public ResponseEntity<String> createPost(@RequestBody Map<String, Object> requestBode) {
        String title = (String) requestBode.get("title");
        String content = (String) requestBode.get("content");
